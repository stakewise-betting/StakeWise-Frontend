          ...
          {loading ? (
            ...
            currentEvents.map((event, index) => (
              ...
              >
                ...
                {/* Expanded Content */}
                {expandedEvent === index && (
                  <div className="p-4 border-t border-zinc-400 bg-[#333447]">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <h4 className="text-gray-400 mb-2">Description</h4>
                        <p className="text-white">{event.description}</p>

                        <h4 className="text-gray-400 mt-4 mb-2">
                          Event Details
                        </h4>
                        ...
                        <div className="space-y-1">
                          <div className="flex justify-between">
                            ...
                            <span className="text-green-400">
                              {Web3.utils.fromWei(event.prizePool, "ether")} ETH
                            </span>
                          </div>
                          <div className="flex justify-between">
                        ...
                        <div className="mt-4 p-3 bg-[#2e3446] rounded-lg">
                          <p className="text-white">
                            {event.notificationMessage ||
                              "Event completed. Winner has been declared."}
                          </p>
                        </div>
                      </div>
                    </div>
