          ...
          <div className="grid md:grid-cols-2 grid-cols-1 gap-4">
            <div className="flex flex-col justify-center items-center gap-9">
              ...
              <div className="">
                ...
                >
                  ...
                  >
                    ...
                    <div className="text-4xl font-bold">{userLevel.currentLevel}</div>
              ...
              <div className="text-sm text-center">
                <p className="font-bold text-[18px]">{userLevel.xpToNextLevel} more</p>
...
function AchievementCard({
  ...
  return (
    <div className={`flex items-center justify-between px-[18px] py-[14px] h-[85px] rounded-[20px] gap-3 transition-all duration-300 ${
      isUnlocked 
      ...
      <div className={`h-14 w-14 rounded-[10px] flex items-center justify-center shadow-lg transition-all duration-300 ${
        isUnlocked 
