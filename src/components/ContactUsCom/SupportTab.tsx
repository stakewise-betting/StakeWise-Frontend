  ...
  const faqs = [
    {
      ...
      answer: "To withdraw your winnings, go to the 'Wallet' section in your account dashboard. Select 'Withdraw', choose your preferred payment method, enter the amount, and follow the verification steps. Withdrawals are typically processed within 24-48 hours."
    },
    {
      question: "Why was my bet rejected?",
      answer: "Bets can be rejected for several reasons: insufficient balance, betting limits exceeded, odds changed during placement, or the event has already started. Check your account balance and try placing the bet again with updated odds."
    },
    {
      question: "How do I verify my account?",
      answer: "Account verification requires uploading a government-issued ID, proof of address (utility bill or bank statement), and sometimes payment method verification. Go to 'Account Settings' > 'Verification' to upload your documents. Verification usually takes 24-72 hours."
    },
    {
      question: "Where can I find bonus terms?",
      answer: "Bonus terms and conditions can be found in the 'Promotions' section of your account, or in the footer under 'Terms & Conditions'. Each bonus has specific wagering requirements, time limits, and eligible games that must be met before withdrawal."
    },
  ];
